...
const CountryHistoryTab = ({ filteredCountries, leaderboardData }) => {
  ...
  /* ── how many columns the card grid should have at the current count ── */
  const count = filteredCountries.length;
  // ≤3 items → as many cols as items; 4 → 4; 5-6 → 3; 7-8 → 4; else → 4
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    pt: 1.5,
                    borderTop: '1px solid',
                    borderColor: isDark ? 'rgba(255,255,255,0.10)' : 'rgba(0,0,0,0.02)',
                  }}
                >
